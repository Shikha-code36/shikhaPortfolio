...
export const Blog: React.FC = () => {
  ...
  const featuredArticles = [
    {
      ...
      description: 'Lessons from high-frequency trading and real-time system architecture for cryptocurrency arbitrage detection.',
      readTime: '8 min read',
    ...
    },
    {
      ...
      description: 'A reinforcement learning approach to improve CNN computational efficiency without compromising accuracy.',
    ...
    },
    {
      ...
      description: 'Complete guide to building a production-ready monitoring system using Flask and SQLAlchemy.',
  ...
  const getCategoryColor = (category: string) => {
    const colors: { [key: string]: string } = {
      ...
      'Backend Development': 'bg-green-500/20 text-green-300 border-green-500/30',
      'Data Engineering': 'bg-yellow-500/20 text-yellow-300 border-yellow-500/30',
    };
            ...
            {[
              {
                ...
                topics: ['Microservices', 'Distributed Systems', 'Scalability', 'Performance'],
              },
              {
                icon: '🤖',
                title: 'AI & Machine Learning',
                topics: ['Deep Learning', 'LLM Integration', 'RAG Systems', 'Model Optimization'],
              },
              {
                icon: '⚡',
                title: 'High-Performance Computing',
                topics: ['Real-time Systems', 'Low Latency', 'Optimization', 'Concurrency'],
              },
              {
                icon: '📊',
                title: 'Data Engineering',
                topics: ['Streaming', 'ETL Pipelines', 'Data Architecture', 'Analytics'],
              },
            ].map((topic, index) => (
              <div
                key={topic.title}
        ...
        <div className="text-center mt-12">
          <div className="bg-gradient-to-r from-cyan-500/10 to-blue-500/10 rounded-2xl p-8 border border-cyan-500/20">
            ...
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
              Follow my Medium blog for in-depth technical articles, tutorials, and insights from building 
              real-world systems. I share practical knowledge from enterprise projects and research.
            </p>
            <a
              href="https://pandeyshikha075.medium.com/"
              target="_blank"
