  ...
  const projects = [
    {
      ...
      project: {
        ...
        description: 'Real-time arbitrage detection system with microsecond precision',
        techStack: ['C++', 'WebSocket', 'Financial APIs', 'Real-time Processing', 'High-frequency Trading'],
        features: [
        ...
        impact: 'Detecting arbitrage opportunities across multiple exchanges with microsecond precision',
      },
    },
    {
      ...
      project: {
        ...
        description: 'No-fluff, easy-to-use CRM tool designed specifically for solopreneurs',
        techStack: ['React', 'Node.js', 'PostgreSQL', 'API Integration', 'SaaS'],
        features: [
        ...
        impact: 'Empowering solopreneurs with streamlined business management tools',
      },
    },
    {
      ...
      project: {
        ...
        description: 'Research project on optimizing CNN efficiency using Reinforcement Learning',
        techStack: ['PyTorch', 'Deep Learning', 'Reinforcement Learning', 'CNN Optimization'],
        features: [
        ...
        impact: 'Contributing novel optimization strategies to AI/ML research community',
      },
    },
    {
      ...
      project: {
        ...
        description: 'Complete AI-powered mock interview platform for job preparation',
        techStack: ['FastAPI', 'Microservices', 'AI Integration', 'Real-time Systems'],
        features: [
        ...
        impact: 'Enabling AI-powered interview preparation for thousands of job seekers',
      },
    },
    {
      ...
      project: {
        ...
        description: 'Enterprise-scale data processing system with high-throughput capabilities',
        techStack: ['Apache Kafka', 'Apache Airflow', 'Python', 'ETL', 'Real-time Processing'],
        features: [
        ...
        impact: 'Processing millions of events per second with enterprise-grade reliability',
      },
    },
  ];
            ...
            >
              <div className="mb-6">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-cyan-400">{item.category}</h3>
                </div>
              ...
              <div className="grid lg:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <div className="mt-6 p-4 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 rounded-lg border border-cyan-500/20">
                    <h5 className="text-sm font-semibold text-cyan-400 mb-2">Impact</h5>
                    <p className="text-gray-300 text-sm italic">"{item.project.impact}"</p>
                  </div>
                </div>
              </div>
            </div>
